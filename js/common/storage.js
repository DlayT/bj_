define([], function() {
	...
	function getLengthPlus() {
		...
		return mui.os.plus ? plus.storage.getLength() : 0;
	};
	...
	function removeItemPlus(k) {
		return mui.os.plus && plus.storage.removeItem(k);
	};
	...
	myStorage.clear = function() {
		...
		return mui.os.plus && plus.storage.clear();
	};
	...
	function keyPlus(index) {
		return mui.os.plus && plus.storage.key(index);
	};
